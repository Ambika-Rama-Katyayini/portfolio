  ...
  return (
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-no-repeat bg-center bg-[length:90%_auto]'>
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        <textarea name='message' className='w-full p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6' rows='6' name="" id="" placeholder='Enter your message' required></textarea>
        <button
          className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500'
          type='submit'>Submit Now
          <Image src={assets.right_arrow_white} alt='Contact right arrow icon'
            className='w-4' />
        </button>
